...
class hu_result():
    ...
    def middle_hole(self):
        ...
        for i in range(34):
            if mj == i:
                # print(i, i-1, i+1)
                # print(i-1, self.mj.count(i-1))
                # print(i, self.mj.count(i)+1)
                # print(i+1, self.mj.count(i+1))
                if i-1 not in self.mj or i+1 not in self.mj:
                    return 0
                if self.mj.count(i-1) != self.mj.count(i)+1 and self.mj.count(i+1) != self.mj.count(i)+1:
                    return 0
    ...
    def side_hu(self):
        ...
        for i in range(34):
            if mj == i:
                ...
                print(i-1, self.mj.count(i-1))
                print(i, self.mj.count(i)+1)
                print(i-2, self.mj.count(i-2))
                if i != 2 or i != 6 or i != 11 or i != 15 or i != 20 or i != 24:
                    return 0
